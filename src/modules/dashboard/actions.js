...
export const setWidgetFutureData = createAction('DASHBOARD/setWidgetFutureData');
export const setWidgetStats = createAction('DASHBOARD/setWidgetStats');
export const setWidgetFutureStats = createAction('DASHBOARD/setWidgetFutureStats');
